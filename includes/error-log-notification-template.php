			...
			<table class="form-table" role="presentation">
				<tbody>
					...
					<tr>
						...
						<td>
							<textarea class="" id="elvwp_notification_emails" name="elvwp_notification_emails" ><?php echo esc_textarea( is_array( $elvwp_notification_emails ) ) ? implode( ', ', $elvwp_notification_emails ) : esc_attr( $elvwp_notification_emails ); ?></textarea>
							<br>
